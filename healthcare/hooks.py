...
app_include_css = [
    "/assets/healthcare/css/responsive_navbar.css",
    "/assets/healthcare/css/healthcare_theme.css",
    "/assets/healthcare/css/patient_list.css",
    "/assets/healthcare/css/healthcare_custom.css",
    "/files/healthcare_background.css",
    "/assets/healthcare/css/patient_custom.css",
    "/assets/healthcare/css/custom_sidebar.css",
    "/assets/healthcare/css/patient_form.css",
    "/assets/healthcare/css/reception_dashboard.css",
    "/assets/healthcare/css/doctor_dashboard.css",
    "/assets/healthcare/css/enhanced_navbar.css"
]
app_include_js = [
    "healthcare.bundle.js",
    "/assets/healthcare/js/socket_fix.js",  # Fix socket.io connection errors
    "/assets/healthcare/js/simple_navbar.js",
    "/assets/healthcare/js/healthcare.min.js",
    "/assets/healthcare/js/appointment_router.js",
    "/assets/healthcare/js/patient_list_custom.js",
    "/assets/healthcare/js/patient_form_custom.js",
    "/assets/healthcare/js/role_redirect.js",
    "/assets/healthcare/js/sidebar_fix.js",  # Commented out to restore standard sidebar behavior
    "/assets/healthcare/js/workspace_search.js",
    "/assets/healthcare/js/show_search_bar.js",
    "/assets/healthcare/js/build_page_navbar.js",  # Add navbar with search bar for the build page
    "/assets/healthcare/js/enhanced_navbar.js"  # Enhanced navbar with notifications and search
]

# include js, css files in header of web template
# webapp_include_css = ["/assets/healthcare/css/healthcare.css", "/assets/healthcare/css/lab_dashboard.css"]
