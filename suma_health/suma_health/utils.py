...
from suma_health.healthcare.doctype.lab_test.lab_test import create_multiple
from suma_health.healthcare.doctype.observation.observation import add_observation
from suma_health.healthcare.doctype.observation_template.observation_template import (
	get_observation_template_details,
)
from suma_health.setup import setup_healthcare
...
def get_appointment_type_billing_details(appointment_type, dep_su, is_inpatient):
	from suma_health.healthcare.doctype.appointment_type.appointment_type import get_billing_details
