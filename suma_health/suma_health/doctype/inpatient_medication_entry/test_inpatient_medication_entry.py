...
from suma_health.healthcare.doctype.healthcare_settings.healthcare_settings import get_account
...
from suma_health.healthcare.doctype.inpatient_medication_order.test_inpatient_medication_order import (
	create_ipme,
	create_ipmo,
)
...
class TestInpatientMedicationEntry(IntegrationTestCase):
	def setUp(self):
