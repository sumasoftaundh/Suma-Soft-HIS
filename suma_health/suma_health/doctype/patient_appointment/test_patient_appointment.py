...
from suma_health.healthcare.doctype.patient_appointment.patient_appointment import (
...
class TestPatientAppointment(IntegrationTestCase):
	...
	def test_overlap_appointment(self):
		from suma_health.healthcare.doctype.patient_appointment.patient_appointment import OverlapError
