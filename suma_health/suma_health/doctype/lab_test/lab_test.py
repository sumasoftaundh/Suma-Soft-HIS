...
class LabTest(Document):
	...
	def on_submit(self):
		# Use the function directly from main utils module
		from suma_health.healthcare.utils import validate_nursing_tasks
		
		# Call the function with a properly named parameter
		validate_nursing_tasks(document=self)
