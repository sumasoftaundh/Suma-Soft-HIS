...
def setup_healthcare():
	...
	from suma_health.regional.india.abdm.setup import setup as abdm_setup
...
def create_default_root_service_units():
	from suma_health.healthcare.utils import create_healthcare_service_unit_tree_root
